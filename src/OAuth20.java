...
import POJOOAuth.Api;
import POJOOAuth.GetCourse;
import POJOOAuth.WebAutomation;
...
public class OAuth20 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Pojo class and deserialization
		...
		for(int i=0; i<wa.size(); i++) {
			System.out.println("Course Title: "+wa.get(i).getCourseTitle());
		}
